...
RSpec.describe Event, type: :model do
  ...
  context "validation" do
    ...
    describe "#start_date" do
      ...
      it { is_expected.not_to allow_value(03-2012).for(:start_date) }
      it { is_expected.not_to allow_value(06/06/2018).for(:start_date) }
    end
    ...
    describe "#duration" do
      ...
      it { is_expected.not_to allow_value(13).for(:duration) }
    ...
    describe "#location" do
      ...
      it { is_expected.not_to allow_value(56).for(:location) }
    end
